...
const Hero = () => {
    ...
    return (
        <div className="px-4 sm:px-20 xl:px-30 relative inline-flex flex-col w-full justify-center bg-[url('/gradientBackground.png')] bg-cover bg-no-repeat min-h-screen">
